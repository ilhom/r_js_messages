var help_messages = {
  'help_bills_sum_by_day': {
    title: 'Изменения суммы счетов по дням',
    text: 'Изменения суммы счетов по дням текст'
  },
...
var notify_messages = {
    ...
    'restaurant_not_created': {
      theme: 'error',
      title: '',
      message: 'Ресторан не создан.'
    },
    'member_created': {
      theme: 'notice',
      title: 'Создано!',
    ...
    'inventory_updated': {
      theme: 'notice',
      title: '',
      message: 'Изменения инвентаризации сохранены'
    },
    'bills_deleted': {
      theme: 'notice',
      title: '',
